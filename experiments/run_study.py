...
* ``rm_small`` / ``rm_large`` — a learned reward model trained on 80 / 1600 labelled
...
The loop logic lives in ``rhlab.study`` (shared with ``rhlab demo``).
"""
